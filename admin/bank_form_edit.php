...
// print_r($_GET);
// exit();
$ID = mysqli_real_escape_string($con,$_GET["ID"]);  //รับค่าเก็ทที่ส่งเข้ามา
$sql = "SELECT * FROM tbl_bank WHERE b_id =$ID"; //โชว์แค่1
...
<form action="bank_form_edit_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      โลโก้เดิม : <br>
      <img src="../b_logo/<?php echo $row['b_logo']?>" width="200px" alt="">
      <br>
